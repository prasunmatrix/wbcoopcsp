@extends('admin.layouts.app', ['title' =>$rangeUserDetails['panel_title']])
...
<section class="content-header">
    <h1>
        {{ $rangeUserDetails['page_title'] }}
    </h1>
    <ol class="breadcrumb">
        <li><a><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">{{ $rangeUserDetails['page_title']}}</li>
    </ol>
</section>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <form method="POST" name="add_range_details" id="add_range_details" action="{{route('admin.range.rangeSubmit')}}" enctype="multipart/form-data">
                    {{ csrf_field() }} 
                        <div class="card-body">
                        <div class="row">  
                            <div class="col-md-4">
                        ...
                        <div class="row">  
                            <div class="col-md-6">
                                ...
                                <select name="zone_id" id="zone_id" class="form-control">
                                    ...
                                    <option value="{{$bankValue->id}}">{{@$bankValue->full_name}}</option>
                                    @endforeach
                                </select>
                                </div>
                            </div>
                        ...
                        <input type="hidden" name="user_id" id="user_id" value="{{@$rangeUserDetails->id}}">
                        <!-- /.card-body -->

        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="row">
                        <form name="filter" id="filter" method="GET" action="{{ route('admin.range.list') }}">
                            ...
                            <div class="col-sm-4">
                                ...
                                <a class="btn btn-primary modal-action-btn" href="{{ route('admin.range.list') }}" style="margin-top:20px;">Reset</a>
                                
                            </div>
                            <div class="col-sm-2">
                                <a class="btn btn-primary modal-action-btn" href="{{ route('admin.range.add') }}" style="margin-top:20px;">Add Range</a>
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    ...
                                                    @if(isset($row->userProfile->zone_id))
                                                        @if($row->userProfile->zone_id != NULL || $row->userProfile->zone_id !='')
                                                            {{ @$row->userProfile->userRange->full_name }}
                                                        @else
                                                            No records found
                                                        @endif
                                                    @else
                                                ...
                                                <td>
                                                    @if(isset($row->status))
                                                        ...
                                                        @if($row->status == '1')
                                                            <a onclick="return confirm('Are you sure ? Want to change the status!!')" href="{{ route('admin.range.status', [$row->id]) }}" title="Change Status" style="color:green"><i class="fa fa-check" aria-hidden="true"></i></a>
                                                        @else
                                                            <a onclick="return confirm('Are you sure ? Want to change the status!!')" href="{{ route('admin.range.status', [$row->id]) }}"  title="Change Status" style="color:red">X</a>
                                                        @endif
                                                        @else
                                                            No records found
                                                        @endif
                                                ...
                                                <td>
                                                    <button>
                                                    <a href="{{ route('admin.range.edit',[$row->id]) }}" title="Edit">

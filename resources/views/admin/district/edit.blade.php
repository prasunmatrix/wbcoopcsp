        ...
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                {{ Form::open(array(
		                            'method'=> 'POST',
		                            'class' => '',
                                    'route' => ['admin.district.editSubmit', $details["id"]],
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('district_name', $details->district_name, array(
                                                                'id' => 'district_name',
                                                                'class' => 'form-control',
                                                                'placeholder' => 'Name',
                                                                'required' => 'required' )) }}
                    ...
                    <div class="box-footer">
                        <div class="col-md-6">
                            ...
                            <a href="{{ route('admin.district.list') }}" class="btn btn-block btn-default btn_width_reset">Cancel</a>
                        </div>
                    </div>
                {!! Form::close() !!}
            </div>

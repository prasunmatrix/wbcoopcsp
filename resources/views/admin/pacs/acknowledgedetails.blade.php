                 ...
                 <form method="POST" name="edit_acknowledgement_form" id="edit_acknowledgement_form" action="{{route('admin.pacs.pacsAcknowledement')}}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <label for="title">Bank<span class="red_star">*</span></label>
                                    <select name="bank_id" id="bank_id" class="form-control" value="{{old('bank_id')}}" onchange="getPacsZone(this.value)" required readonly> 
                            ...
                            <div class="col-md-6">
                                ...
                                <label for="title">Zone<span class="red_star">*</span></label>
                                    <select name="zone_id" id="zone_id" class="form-control" value="{{old('zone_id')}}" onchange="getPacsRange(this.value)" required readonly>
                                        <option value="">-Select-</option>
                                @if (count($zoneList))
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <label for="title">Range<span class="red_star">*</span></label>
                                    <select name="range_id" id="range_id" class="form-control" value="{{old('range_id')}}" readonly>
                                        <option value="">-Select-</option>
                                @if (count($rangeList))
                            ...
                            <div class="col-md-6">
                                ...
                                <label for="title">District<span class="red_star">*</span></label>
                                    <select name="district_id" id="district_id" class="form-control" value="{{old('district_id')}}" onchange="getPacsBlock(this.value)"  required readonly>
                                        <option value="">-Select-</option>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <label for="title">Block<span class="red_star">*</span></label>
                                    <select name="block_id" id="block_id" class="form-control" value="{{old('block_id')}}" required readonly>
                                        <option value="">-Select-</option>
                                @if (count($blockList))
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                <label for="title">Software<span class="red_star">*</span></label>
                                    <select name="software_using" id="software_using" class="form-control" value="{{old('software_using')}}" required readonly>
                                        <option value="">-Select-</option>
                                @if (count($softwareList))
                                    @foreach ($softwareList as $state)
                                        <option value="{{$state->id}}" @if($state->id == $details->userProfile['software_using'] ) selected="selected" @endif>{{$state->software_name}}</option>
                                    @endforeach
                                @endif
                                    </select>
                                </div>
                        ...
                        <div class="class row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="name">Society Type<span class="red_star">*</span></label>
                                    {{ Form::text('socity_type', $details->userProfile->socity_type, array(
                                                                'id' => 'socity_type',
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" name="information_correct_verified" id="information_correct_verified" value="{{$details->userProfile->information_correct_verified}}" readonly>
                        ...
                        <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" name="unique_id_noted" id="unique_id_noted" value="{{$details->userProfile->unique_id_noted}}" readonly>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" name="pacs_using_software" id="pacs_using_software" value="{{$details->userProfile->pacs_using_software}}" readonly>
                                        <label for="name"><span class="red_star">*</span>PACS is using the software mentioned above.</label>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" name="pacs_uploaded_format" id="pacs_uploaded_format" value="$details->userProfile->pacs_uploaded_format" readonly>

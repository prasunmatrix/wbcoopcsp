    ...
    <div class="col-md-12">
      <div class="box">
        <div class="box-header with-border">
          ...
          <div class="row">
            <form name="filter" id="filter" method="GET" action="{{ route('admin.pacs.list') }}">
              ...
              <div class="col-sm-4">
                ...
                <a class="btn btn-primary modal-action-btn" href="{{ route('admin.pacs.list') }}" style="margin-top:20px;">Reset</a>

              </div>
              <div class="col-sm-2">
                <a class="btn btn-primary modal-action-btn" href="{{ route('admin.pacs.add') }}" style="margin-top:20px;">Add PACS</a>
            ...
            <tbody>
              <tr role="row" class="odd">
                ...
                <td class="sorting_1">
                  ...
                  @if($row->userProfile->userBlock!=NULL || $row->userProfile->userBlock!='')
                  {{ $row->userProfile->userBlock->block_name }}
                  @else
                ...
                <td>
                  ...
                  @if($row->status == '1')
                  <a onclick="return confirm('Are you sure ? Want to change the status!!')" href="{{ route('admin.pacs.status', [$row->id]) }}" title="Change Status" style="color:green"><i class="fa fa-check" aria-hidden="true"></i></a>
                  @else
                  <a onclick="return confirm('Are you sure ? Want to change the status!!')" href="{{ route('admin.pacs.status', [$row->id]) }}" title="Change Status" style="color:red">X</a>
                  @endif
                  @else
                  No records found
                  @endif
                ...
                <td>
                  <button>
                    ...
                    <a href="{{ route('admin.pacs.edit', [$row->id]) }}" title="Edit">

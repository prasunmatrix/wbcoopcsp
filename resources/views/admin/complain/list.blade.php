        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="row">
                        <form name="filter" id="filter" method="GET" action="{{ route('admin.complain.list') }}">
                            ...
                            <div class="col-sm-4">
                                ...
                                <a class="btn btn-primary modal-action-btn" href="{{ route('admin.complain.list') }}" style="margin-top:20px;">Reset</a>
                                
                            </div>
                            <div class="col-sm-2">   
                                <a class="btn btn-primary modal-action-btn" href="{{ route('admin.complain.add') }}" style="margin-top:20px;">Raise a Complain</a>
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td>
                                                @if(isset($row->status))
                                                    ...
                                                    @if($row->status == '1')
                                                    <a onclick="return confirm('Are you sure ? Want to change the status!!')" href="{{ route('admin.complain.changestatus', [$row->id]) }}" title="" style=""><span class="yellowBt">Ongoing</span></a>
                                                    @elseif ($row->status == '2')
                                            ...
                                            <td>
                                                ...
                                                @if(\Auth::guard('admin')->user()->id == $row->reported_to)
                                               ...
                                               <button>
                                                ...
                                                <a  href="{{ route('admin.complain.view', [$row->id]) }}" title="View Complain">

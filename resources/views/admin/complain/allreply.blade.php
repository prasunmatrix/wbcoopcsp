        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="row">
                        <form name="filter" id="filter" method="GET" action="{{ route('admin.complain.alllreply') }}">
                            ...
                            <div class="col-sm-6">
                                ...
                                <a class="btn btn-primary modal-action-btn" href="{{ route('admin.complain.alllreply') }}" style="margin-top:20px;">Reset</a>
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td>
                                               ...
                                               <button>
                                                ...
                                                <a  href="{{ route('admin.complain.viewreply', [$row->id]) }}" title="View Complain">

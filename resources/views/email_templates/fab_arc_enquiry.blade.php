            ...
            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;background-color:#ffffff;font-family:Arial, Helvetica, sans-serif;">
                ...
                <td valign="middle" class="hero bg_white" style="padding:0 25px;">
                        ...
                        <tr>
                            <td>
                                <div class="text" style="padding:0; text-align: center;">
                                    <h1 style="font-family:Arial, Helvetica, sans-serif;font-size:22px;line-height:32px; color:green;margin: 0 auto 20px;padding: 0;">{{ $app_config['appname'] }} Fabricator / Architact Enquiry</h1>
                                    <h2 style="font-family:Arial, Helvetica, sans-serif;font-size:18px;line-height:20px; color:rgb(2, 2, 77);margin:auto 10px;padding: 0;text-align: left;">Hello Admin</h2>
                                    <p style="font-family:Arial, Helvetica, sans-serif;font-size:16px;line-height:18px; color:rgb(2, 2, 77);margin:0 auto 0px;padding: 0; text-align: left;">
                                        {{ $user->full_name }} generate an Enquiry for {{ $checkFabArc->full_name }} Type : @if($checkFabArc->audience_type == 'A') Architact @endif
                                        @if($checkFabArc->audience_type == 'F') Fabricator @endif 
                                    </p>
                                </div>
                            </td>
                        </tr>
                    ...
                    <table width="100%" style="margin:15px auto 35px; border: 1px solid #e6e6e6;border-collapse: collapse;">
                        <thead>
                          <tr>
                            <th style="font-family:Arial, Helvetica, sans-serif;font-size:16px;line-height:18px; color:rgb(2, 2, 77);margin:0 auto 0px;padding:10px 5px; text-align: center;border: 1px solid #e6e6e6; background-color:#f6f6f6;">Name</th>
                            <th style="font-family:Arial, Helvetica, sans-serif;font-size:16px;line-height:18px; color:rgb(2, 2, 77);margin:0 auto 0px;padding:10px 5px; text-align: center;border: 1px solid #e6e6e6;background-color:#f6f6f6;">Phone Number</th>
                            ...
                            <th style="font-family:Arial, Helvetica, sans-serif;font-size:16px;line-height:18px; color:rgb(2, 2, 77);margin:0 auto 0px;padding:10px 5px; text-align: center;border: 1px solid #e6e6e6;background-color:#f6f6f6;">Comment</th>
                          </tr>
                        </thead>
                        <tbody>
                            <tr>
                              ...
                              <td style="font-family:Arial, Helvetica, sans-serif;font-size:14px;line-height:18px; color:#000;margin:0 auto 0px;padding:10px 5px; text-align: center;border: 1px solid #e6e6e6;">
                                  @if(isset($enquiryDetails->phone_number))
                                      {{ $enquiryDetails->phone_number }}
                                  @else
                                      No Email found
                                  @endif
                              </td>
                              <td style="font-family:Arial, Helvetica, sans-serif;font-size:14px;line-height:18px; color:#000;margin:0 auto 0px;padding:10px 5px; text-align: center;border: 1px solid #e6e6e6;">
                                @if(isset($enquiryDetails->email))
                            ...
                            <td style="font-family:Arial, Helvetica, sans-serif;font-size:14px;line-height:18px; color:#000;margin:0 auto 0px;padding:10px 5px; text-align: center;border: 1px solid #e6e6e6;">
                                @if(isset($enquiryDetails->comment))

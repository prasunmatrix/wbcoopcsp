                        ...
                        <tr>
                            <td>
                                <div class="text" style="padding:0; text-align: center;">
                                    <h1 style="font-family:Arial, Helvetica, sans-serif;font-size:22px;line-height:32px; color:#f7941d;margin: 0 auto 20px;padding: 0;">{{ $app_config['subject'] }}</h1>
                                    <h2 style="font-family:Arial, Helvetica, sans-serif;font-size:18px;line-height:20px; color:#000;margin:0 auto 10px;padding: 0;text-align: left;">Hello {{ $user->userDetails->full_name }}</h2>

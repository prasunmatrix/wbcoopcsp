    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <form method="POST" name="add_zone_details" id="add_zone_details" action="<?php echo e(route('admin.zone.zoneSubmit')); ?>" enctype="multipart/form-data">
                    <?php echo e(csrf_field()); ?> 
                        ...
                        <a href="<?php echo e(route('admin.zone.list')); ?>" class="btn btn-block btn-default btn_width_reset">Cancel</a>
                        </div>
                </form>
                </div>
            </div>
...
<?php echo $__env->make('admin.layouts.app', ['title' =>$bankUserDetails['panel_title']], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/prasun/wbcoopcsp/resources/views/admin/zone_user/add.blade.php ENDPATH**/ ?>
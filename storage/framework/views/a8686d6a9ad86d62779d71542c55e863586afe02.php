...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo e(route('admin.range.pacs')); ?>"><i class="fa fa-home" aria-hidden="true"></i>Pacs List</a></li>
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <?php echo e(Form::open(array(
		                            'method'=> 'POST',
		                            'class' => '',
                                    'route' => ['admin.range.pacseditSubmit', $details["id"]],
                                    'title'  => 'editCityForm',
                                    'id'    => 'editCityForm',
                                    'files' => true,
		                            'novalidate' => true))); ?>
                    ...
                    <div class="box-footer">
                        <div class="col-md-6">
                            ...
                            <a href="<?php echo e(route('admin.range.pacs').'?page='.$data['pageNo']); ?>" title="Cancel" class="btn btn-block btn-default btn_width_reset">Cancel</a>
                        </div>
                    </div>
                <?php echo Form::close(); ?>
...
<?php echo $__env->make('admin.layouts.app', ['title' => $data['panel_title']], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\matrixmedia\wbcoopcsp\resources\views/admin/range_user/pacsedit.blade.php ENDPATH**/ ?>
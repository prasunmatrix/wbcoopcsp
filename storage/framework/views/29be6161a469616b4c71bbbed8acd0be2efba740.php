        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="row">
                        <form name="filter" id="filter" method="GET" action="<?php echo e(route('admin.complain.alllreply')); ?>">
                            ...
                            <div class="col-sm-6">
                                ...
                                <a class="btn btn-primary modal-action-btn" href="<?php echo e(route('admin.complain.alllreply')); ?>" style="margin-top:20px;">Reset</a>
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td>
                                               ...
                                               <button>
                                                ...
                                                <a  href="<?php echo e(route('admin.complain.viewreply', [$row->id])); ?>" title="View Complain">
...
<?php echo $__env->make('admin.layouts.app', ['title' => $panel_title], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\matrixmedia\wbcoopcsp\resources\views/admin/complain/allreply.blade.php ENDPATH**/ ?>
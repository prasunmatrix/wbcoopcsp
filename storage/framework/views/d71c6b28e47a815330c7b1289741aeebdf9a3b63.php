        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="row">
                        <form name="filter" id="filter" method="GET" action="<?php echo e(route('admin.complain.list')); ?>">
                            ...
                            <div class="col-sm-4">
                                ...
                                <a class="btn btn-primary modal-action-btn" href="<?php echo e(route('admin.complain.list')); ?>" style="margin-top:20px;">Reset</a>
                                
                            </div>
                            <div class="col-sm-2">   
                                <a class="btn btn-primary modal-action-btn" href="<?php echo e(route('admin.complain.add')); ?>" style="margin-top:20px;">Raise a Complain</a>
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td>
                                                <?php if(isset($row->status)): ?>
                                                    ...
                                                    <?php if($row->status == '1'): ?>
                                                    <a onclick="return confirm('Are you sure ? Want to change the status!!')" href="<?php echo e(route('admin.complain.changestatus', [$row->id])); ?>" title="" style=""><span class="yellowBt">Ongoing</span></a>
                                            ...
                                            <td>
                                                ...
                                                <?php if(\Auth::guard('admin')->user()->id == $row->reported_to): ?>
                                               ...
                                               <button>
                                                ...
                                                <a  href="<?php echo e(route('admin.complain.view', [$row->id])); ?>" title="View Complain">
...
<?php echo $__env->make('admin.layouts.app', ['title' => $panel_title], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\matrixmedia\wbcoopcsp\resources\views/admin/complain/list.blade.php ENDPATH**/ ?>
...
<section class="content">
  ...
  <div class="box-footer">
    <div class="col-md-6">
      ...
      <a href="<?php echo e(route('admin.bank.pacslist').'?page='.$data['pageNo']); ?>" title="Cancel" class="btn btn-block btn-default btn_width_reset">Cancel</a>
    </div>
  </div>
  <?php echo Form::close(); ?>
...
<?php echo $__env->make('admin.layouts.app', ['title' => $data['panel_title']], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\matrixmedia\wbcoopcsp\resources\views/admin/bank_user/pacsedit.blade.php ENDPATH**/ ?>
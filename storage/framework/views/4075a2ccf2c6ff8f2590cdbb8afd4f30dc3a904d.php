                    ...
                    <div class="box-body cus-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <?php echo e(Form::text('block', null, array(
                                                                'id' => 'block',
                                                                'placeholder' => 'Block',
                                                                'class' => 'form-control'
                                                                 ))); ?> 
...
<?php echo $__env->make('admin.layouts.app', ['title' => $panel_title], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\matrixmedia\wbcoopcsp\resources\views/admin/range_user/pacsadd.blade.php ENDPATH**/ ?>
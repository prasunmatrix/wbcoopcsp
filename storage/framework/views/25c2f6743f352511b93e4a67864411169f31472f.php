            ...
            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;background-color:#ffffff;font-family:Arial, Helvetica, sans-serif;">
                ...
                <td valign="middle" class="hero bg_white" style="padding:0 25px;">
                        ...
                        <tr>
                            <td>
                                <div class="text" style="padding:0; text-align: center;">
                                    <h1 style="font-family:Arial, Helvetica, sans-serif;font-size:22px;line-height:32px; color:#f7941d;margin: 0 auto 20px;padding: 0;"><?php if(isset($app_config['Password'])): ?> <?php echo e($app_config['subject']); ?><?php endif; ?></h1>
                                    <h2 style="font-family:Arial, Helvetica, sans-serif;font-size:18px;line-height:20px; color:#000;margin:0 auto 10px;padding: 0;text-align: left;">Hello <?php echo e($user->full_name); ?></h2>
                    ...
                    <table width="100%" style="margin:15px auto 35px; border: 1px solid #e6e6e6;border-collapse: collapse;">
                        <thead>
                          <tr>
                            <th style="font-family:Arial, Helvetica, sans-serif;font-size:16px;line-height:18px; color:#000;margin:0 auto 0px;padding:10px 5px; text-align: center;border: 1px solid #e6e6e6; background-color:#f6f6f6;">Username</th>
                            <th style="font-family:Arial, Helvetica, sans-serif;font-size:16px;line-height:18px; color:#000;margin:0 auto 0px;padding:10px 5px; text-align: center;border: 1px solid #e6e6e6;background-color:#f6f6f6;">Password</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                            ...
                            <td style="font-family:Arial, Helvetica, sans-serif;font-size:14px;line-height:18px; color:#000;margin:0 auto 0px;padding:10px 5px; text-align: center;border: 1px solid #e6e6e6;">
                                <?php if(isset($app_config['Password'])): ?>
                                    <?php echo e($app_config['Password']); ?>
...
</html><?php /**PATH C:\xampp\htdocs\matrixmedia\wbcoopcsp\resources\views/email_templates/bank_credential.blade.php ENDPATH**/ ?>
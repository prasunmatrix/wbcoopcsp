        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="row">
                        <form name="filter" id="filter" method="GET" action="<?php echo e(route('admin.bank.list')); ?>">


                            <div class="col-sm-6">
                                <label class="w-100">[Name/Phone/Email/IFSC Code]
                            ...
                            <div class="col-sm-4">
                                ...
                                <a class="btn btn-primary modal-action-btn" href="<?php echo e(route('admin.bank.list')); ?>" style="margin-top:20px;">Reset</a>
                                
                            </div>
                            <div class="col-sm-2">

                                <a class="btn btn-primary modal-action-btn" href="<?php echo e(route('admin.bank.add')); ?>" style="margin-top:20px;">Add Bank</a>
                                    ...
                                    <?php if(count($data['list'])>0): ?>
                                        ...
                                        <tbody>
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    <?php if(isset($row->userProfile->ifsc_code)): ?>
                                                        <?php if($row->userProfile->ifsc_code != NULL || $row->userProfile->ifsc_code !=''): ?>
                                                            <?php echo e($row->userProfile->ifsc_code); ?>
                                                ...
                                                <td>
                                                    <?php if(isset($row->status)): ?>
                                                        ...
                                                        <?php if($row->status == '1'): ?>
                                                            <a onclick="return confirm('Are you sure ? Want to change the status!!')" href="<?php echo e(route('admin.bank.status', [$row->id])); ?>" title="Change Status" style="color:green"><i class="fa fa-check" aria-hidden="true"></i></a>
                                                        <?php else: ?>
                                                            <a onclick="return confirm('Are you sure ? Want to change the status!!')" href="<?php echo e(route('admin.bank.status', [$row->id])); ?>"  title="Change Status" style="color:red">X</a>
                                                        <?php endif; ?>
                                                        <?php else: ?>
                                                            No records found
                                                        <?php endif; ?>
                                                ...
                                                <td>
                                                    <button>
                                                    <a href="<?php echo e(route('admin.bank.edit',[$row->id])); ?>" title="Edit">
...
<?php echo $__env->make('admin.layouts.app', ['title' => $data['panel_title']], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\matrixmedia\wbcoopcsp\resources\views/admin/bank_user/list.blade.php ENDPATH**/ ?>